...
const surfaces = [
  ...
  },
  {
    ...
    checks: [
      ...
      ["onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); setScoutDrawerPid(pick.pid); } }}", 'draft rows support keyboard activation'],
      ['className="draft-scout-drawer"', 'scout drawer renders the player scouting card'],
